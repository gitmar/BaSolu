...
namespace GxTie.Services
{
    public sealed class PendingChangesGuard : IAsyncDisposable
    {
        ...
        // 🔥 GENERALIZED - Replaces Tiewel-specific methods
        ...
        // 🔥 NEW: Generic version for Tiwafl + others
        ...
        //    // 🔥 UNIVERSAL: ALL registered predicates (Tiewel/Tiwafl/Rubfmt/...)
        //    foreach (var kvp in _unconfirmedPredicates)
        //    {
        //        var entityType = kvp.Key;
        //        var predicate = kvp.Value;
        ...
        //    //       !(e.Entity is Tiewel p && (p.Xadd1 == -1 || p.Xedt1 == -1)));
        //    // 🔥 GENERALIZED: Use predicates instead of Tiewel-specific check
        //    return _ctx.Context.Entities.Any(e => IsPendingState(e.State) &&
