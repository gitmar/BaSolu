namespace GxShared.Formulas.ForaModels
{
    ...
    public class OutDataLineStream // writable at client, read only at server
    {
        ...
        public string? Smatri { get; set; }   // Matrix code
        // Behavioral flags
        public bool IsWritable => !Scdrub.EndsWith("c", StringComparison.OrdinalIgnoreCase);
        public bool IsDetail => Scdrub.EndsWith("d", StringComparison.OrdinalIgnoreCase);
        // author infos
        public DateTime EvaluationTime { get; set; }
        public string EvaluatedBy { get; set; } // e.g. operator login
    }
