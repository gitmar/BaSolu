...
namespace GxShared.Sess
{
    public class Gpdivh
    {
        ...
        public Guid? Khie { get; set; }
        public Guid? Kpln { get; set; }
        ...
        public string Xcod { get; set; } = string.Empty;
        public ICollection<Divpst> Divpsts { get; set; } = new List<Divpst>();
    }
    public class Divpst
    {
        public int Ipst { get; set; }
        public int Ihie { get; set; }
        public Guid? Kpst { get; set; }
        public Guid? Khie { get; set; }
        public int Code { get; set; } = 0;
        public string Liba { get; set; } = string.Empty;
        public string Abg { get; set; } = string.Empty;
